...
var _excluded = ["appearance", "elemBefore", "isRemovable", "text", "color", "href", "removeButtonLabel", "testId", "onBeforeRemoveAction", "onAfterRemoveAction", "linkComponent", "migration_fallback", "maxWidth"];
...
var RemovableTagComponent = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  if ((0, _platformFeatureFlags.fg)('platform-dst-lozenge-tag-badge-visual-uplifts')) {
    var newColor = _tagNew.colorMapping[color || 'standard'];
    return /*#__PURE__*/React.createElement(_tagNew.default, {
      ref: ref,
      color: newColor,
      text: text,
