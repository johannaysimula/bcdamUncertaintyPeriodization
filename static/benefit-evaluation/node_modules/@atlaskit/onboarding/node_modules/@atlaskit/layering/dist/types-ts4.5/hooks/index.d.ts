 ...
 *
 */
export declare function UNSAFE_useLayering(): {
    currentLevel: number;
    topLevelRef: import("react").MutableRefObject<number | null>;
    isLayerDisabled: () => boolean;
};
export declare const useLayering: typeof UNSAFE_useLayering;
export {};
