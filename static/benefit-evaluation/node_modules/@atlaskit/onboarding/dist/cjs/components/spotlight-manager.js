...
var SpotlightManager = exports.default = /*#__PURE__*/function (_PureComponent) {
  ...
  function SpotlightManager() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "targetRef", function (name) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "spotlightOpen", function () {
      _this.setState(function (state) {
        return {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "spotlightClose", function () {
      _this.setState(function (state) {
        return {
          spotlightCount: state.spotlightCount - 1
        };
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "getStateProviderValue", (0, _memoizeOne.default)(function (targets) {
      return {
