...
const metadata = {
  ...
  'ai-generative-remix': {
    keywords: ['ai-generative-remix', 'aigenerativeremix', 'icon', 'icon-lab', 'transform', 'AI visualization', 'remix with rovo'],
  ...
  'ai-generative-slides': {
    keywords: ['ai-generative-slides', 'aigenerativeslides', 'icon', 'icon-lab', 'slides', 'AI slides', 'presentation'],
  ...
  'approval-start': {
    keywords: ['approval-start', 'approvalstart', 'icon', 'icon-lab', 'approval', 'reapprove', 'approve', 'reapproval'],
  ...
  'dock-toolbar-bottom': {
    keywords: ['dock-toolbar-bottom', 'docktoolbarbottom', 'icon', 'icon-lab', 'dock to bottom', 'fix to bottom', 'pin to bottom'],
  ...
  'dock-window-bottom-left': {
    keywords: ['dock-window-bottom-left', 'dockwindowbottomleft', 'icon', 'icon-lab', 'dock to bottom left', 'fix to bottom left', 'pin to bottom left'],
  ...
  'dock-window-bottom-right': {
    keywords: ['dock-window-bottom-right', 'dockwindowbottomright', 'icon', 'icon-lab', 'dock to bottom right', 'fix to bottom right', 'pin to bottom right'],
  ...
  'hardware-audit': {
    keywords: ['hardware-audit', 'hardwareaudit', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'audit', 'audited', 'checklist'],
  ...
  'hardware-configuration': {
    keywords: ['hardware-configuration', 'hardwareconfiguration', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'configuration', 'settings', 'cog'],
  ...
  'hardware-defect': {
    keywords: ['hardware-defect', 'hardwaredefect', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'damaged', 'defective', 'broken'],
  ...
  'hardware-dispose': {
    keywords: ['hardware-dispose', 'hardwaredispose', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'dispose', 'disposal', 'end of life', 'cross'],
  ...
  'hardware-fulfil': {
    keywords: ['hardware-fulfil', 'hardwarefulfil', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'fulfil', 'fulfill', 'fulfilment', 'fulfillment', 'check mark'],
  ...
  'hardware-new': {
    keywords: ['hardware-new', 'hardwarenew', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'add', 'new', 'plus'],
  ...
  'hardware-procure': {
    keywords: ['hardware-procure', 'hardwareprocure', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'procure', 'procurement', 'purchase', 'currency', 'dollar', 'buy', 'bought'],
  ...
  'hardware-refresh': {
    keywords: ['hardware-refresh', 'hardwarerefresh', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'refresh'],
  ...
  'hardware-repair': {
    keywords: ['hardware-repair', 'hardwarerepair', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'repair', 'fix', 'wrench'],
  ...
  'hardware-return': {
    keywords: ['hardware-return', 'hardwarereturn', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'return', 'returned'],
  ...
  'hardware-ship': {
    keywords: ['hardware-ship', 'hardwareship', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'ship', 'shipping', 'shipped', 'arrow up right'],
  ...
  'hardware-transfer': {
    keywords: ['hardware-transfer', 'hardwaretransfer', 'icon', 'icon-lab', 'screen', 'display', 'hardware', 'transfer', 'transferred', 'change ownership'],
  ...
  'person-lock-locked': {
    keywords: ['person-lock-locked', 'personlocklocked', 'icon', 'icon-lab', 'person', 'permissions', 'locked', 'restricted access'],
  ...
  'person-lock-unlocked': {
    keywords: ['person-lock-unlocked', 'personlockunlocked', 'icon', 'icon-lab', 'person', 'permissions', 'unlocked', 'unrestricted access'],
  ...
  'registry-service': {
    ...
    categorization: 'single-purpose',
    usage: 'Reserved for representing a service registry — a category of software, capabilities, and application services.',
    team: 'JSM',
    status: 'published'
  },
  repeat: {
