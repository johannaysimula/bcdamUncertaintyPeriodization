...
var RemovableTag = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  var hoverCloseButtonColors = useMemo(function () {
    var _ref2;
    return _ref2 = {}, _defineProperty(_ref2, cssVar.color.background.hover, theme.removalHoverBackgroundColors[mode]), _defineProperty(_ref2, cssVar.color.background.active, theme.removalActiveBackgroundColors[mode]), _defineProperty(_ref2, cssVar.color.text.default, theme.removalTextColors[mode]), _defineProperty(_ref2, cssVar.color.text.active, theme.removalTextColors[mode]), _defineProperty(_ref2, cssVar.color.text.link, theme.removalTextColors[mode]), _ref2;
  }, [mode]);
