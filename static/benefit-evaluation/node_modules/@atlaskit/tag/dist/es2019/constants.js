...
export const tagHeight = `var(--ds-space-250, ${`${tagHeightUnitless}px`})`;
...
export const defaultMargin = `var(--ds-space-050, ${`${gridSizeValue / 2}px`})`;
export const defaultTextPadding = `var(--ds-space-050, ${`${gridSizeValue / 2}px`})`;
export const textPaddingRight = `var(--ds-space-200, ${`${2 * gridSizeValue}px`})`;
