  ...
  return (0, _createClass2.default)(VCCalculator_FY25_03, [{
    ...
    value: function isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
      ...
      if (entry.data.type === 'mutation:attribute') {
        ...
        if (_attributeName.startsWith('data-test') || _constants.NON_VISUAL_ARIA_ATTRIBUTES.includes(_attributeName) || _constants.THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES.includes(_attributeName) && (0, _platformFeatureFlags.fg)('platform_ufo_exclude_3p_extensions_from_ttvc') || _constants.DARK_READER_BROWSER_EXTENSION_ATTRIBUTES.includes(_attributeName) && (0, _platformFeatureFlags.fg)('platform_ufo_exclude_dark_reader_extension')) {
          return false;
        }
        return true;
      }
