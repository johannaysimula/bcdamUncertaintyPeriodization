  ...
  return _createClass(VCCalculator_FY25_03, [{
    ...
    value: function isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
      ...
      if (entry.data.type === 'mutation:attribute') {
        ...
        if (_attributeName.startsWith('data-test') || NON_VISUAL_ARIA_ATTRIBUTES.includes(_attributeName) || THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES.includes(_attributeName) && fg('platform_ufo_exclude_3p_extensions_from_ttvc') || DARK_READER_BROWSER_EXTENSION_ATTRIBUTES.includes(_attributeName) && fg('platform_ufo_exclude_dark_reader_extension')) {
          return false;
        }
        return true;
      }
