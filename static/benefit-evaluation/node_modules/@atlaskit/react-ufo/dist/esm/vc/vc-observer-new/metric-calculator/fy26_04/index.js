...
var VCCalculator_FY26_04 = /*#__PURE__*/function (_VCCalculator_FY25_) {
  ...
  return _createClass(VCCalculator_FY26_04, [{
    ...
    value: function isEntryIncluded(entry, include3p, excludeSmartAnswersInSearch) {
      ...
      var thirdPartyAttributes = fg('platform_ufo_exclude_dark_reader_extension') ? [].concat(_toConsumableArray(THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES), _toConsumableArray(DARK_READER_BROWSER_EXTENSION_ATTRIBUTES)) : THIRD_PARTY_BROWSER_EXTENSION_ATTRIBUTES;
      if (entryData.type === 'mutation:display-contents-children-attribute') {
        if (!attributeName || attributeName.startsWith('data-test') || KNOWN_ATTRIBUTES_THAT_DOES_NOT_CAUSE_LAYOUT_SHIFTS.includes(attributeName) || NON_VISUAL_ARIA_ATTRIBUTES.includes(attributeName) || thirdPartyAttributes.includes(attributeName)) {
          return false;
        }
        return true;
      }
