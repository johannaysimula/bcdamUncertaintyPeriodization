 ...
 */
export declare function conditionalHooksFactory<Result, Args extends unknown[]>(condition: () => boolean, newHook: (...args: Args) => Result, oldHook: (...args: Args) => Result): (...args: Args) => Result;
