...
export interface NewCoreIconProps extends BaseNewIconProps, NewCoreGlyphProps, IconInternalGlyphProps {
    type?: 'core';
}
export interface NewUtilityIconProps extends BaseNewIconProps, NewUtilityGlyphProps, IconInternalGlyphProps {
    type: 'utility';
}
export type NewIconProps = NewUtilityIconProps | NewCoreIconProps;
