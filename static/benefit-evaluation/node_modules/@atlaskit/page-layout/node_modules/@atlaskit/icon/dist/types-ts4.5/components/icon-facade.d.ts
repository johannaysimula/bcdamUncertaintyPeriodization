...
import type { NewCoreIconProps, NewUtilityIconProps } from '../types';
/**
...
export declare const IconFacade: React.NamedExoticComponent<import("../types").IconProps & {
    newIcon?: React.ComponentType<NewUtilityIconProps> | React.ComponentType<NewCoreIconProps> | undefined;
